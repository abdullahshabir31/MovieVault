...
function ErrorComponent({ error, reset }) {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <span className="mx-auto mb-4 grid size-12 place-items-center rounded-2xl bg-secondary">
...
export const Route = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "MovieVault — Track every movie you watch" },
      {
        name: "description",
        content:
          "MovieVault is a mobile-first movie tracker: check instantly if you already watched a film, rate it, take notes and build your watchlist.",
      },
      { name: "theme-color", content: "#16181f" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "MovieVault" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:site_name", content: "MovieVault" },
